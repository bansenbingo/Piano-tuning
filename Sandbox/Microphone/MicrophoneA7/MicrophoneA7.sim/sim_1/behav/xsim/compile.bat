...
REM
REM Generated by Vivado on Sat Jul 18 16:07:39 +0800 2026
...
echo "xvlog --incr --relax -prj tb_mic_recorder_vlog.prj"
call xvlog  --incr --relax -prj tb_mic_recorder_vlog.prj -log xvlog.log
